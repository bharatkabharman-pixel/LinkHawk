...
<div class="wrap lgp-wrap">
    ...
    <div class="lgp-page-header">
        <h1 class="lgp-page-title">
            ...
            <?php esc_html_e( 'LinkHawk — Broken Links', 'linkhawk' ); ?>
        </h1>
        <div class="lgp-header-actions">
            ...
            <a href="<?php echo esc_url( admin_url( 'admin-ajax.php?action=lgp_export_csv&nonce=' . wp_create_nonce( 'lgp_export_csv' ) ) ); ?>" class="button">
                ...
                <?php esc_html_e( 'Export CSV', 'linkhawk' ); ?>
            </a>
            <?php endif; ?>
            <a href="<?php echo esc_url( admin_url( 'admin.php?page=linkhawk-settings' ) ); ?>" class="button">
                <span class="dashicons dashicons-admin-settings" style="margin-top:3px;margin-right:3px;"></span>
                <?php esc_html_e( 'Settings', 'linkhawk' ); ?>
            </a>
        </div>
    </div>
    ...
    <div class="lgp-stats-bar">
        ...
        <div class="lgp-stat-card <?php echo $total > 0 ? 'lgp-stat-card--alert' : 'lgp-stat-card--ok'; ?>">
            ...
            <div class="lgp-stat-body">
                ...
                <span class="lgp-stat-label"><?php esc_html_e( 'Total Broken', 'linkhawk' ); ?></span>
            </div>
        </div>
        ...
        <div class="lgp-stat-card">
            ...
            <div class="lgp-stat-body">
                ...
                <span class="lgp-stat-label"><?php esc_html_e( 'Affected Pages', 'linkhawk' ); ?></span>
            </div>
        </div>
        ...
        <div class="lgp-stat-card lgp-stat-card--404">
            ...
            <div class="lgp-stat-body">
                ...
                <span class="lgp-stat-label"><?php esc_html_e( '404 Not Found', 'linkhawk' ); ?></span>
            </div>
        </div>
        ...
        <div class="lgp-stat-card lgp-stat-card--timeout">
            ...
            <div class="lgp-stat-body">
                ...
                <span class="lgp-stat-label"><?php esc_html_e( 'Timeouts / Errors', 'linkhawk' ); ?></span>
            </div>
        </div>
        ...
        <div class="lgp-stat-card lgp-stat-card--image">
            ...
            <div class="lgp-stat-body">
                ...
                <span class="lgp-stat-label"><?php esc_html_e( 'Broken Images', 'linkhawk' ); ?></span>
            </div>
        </div>
        ...
        <div class="lgp-stat-card lgp-stat-card--scan">
            ...
            <div class="lgp-stat-body">
                <span class="lgp-stat-number lgp-last-scan-val" id="lgp-last-scan">
                    <?php echo $last_scan ? esc_html( $last_scan ) : esc_html__( 'Never', 'linkhawk' ); ?>
                </span>
                <span class="lgp-stat-label"><?php esc_html_e( 'Last Scan', 'linkhawk' ); ?></span>
            </div>
        </div>
    ...
    <div class="lgp-toolbar">
        <button id="lgp-scan-btn" class="button button-primary button-hero">
            ...
            <?php esc_html_e( 'Scan Now', 'linkhawk' ); ?>
        </button>
    ...
    <div id="lgp-progress-wrap" style="display:none;">
        <div class="lgp-progress-header">
            <span id="lgp-progress-label"><?php esc_html_e( 'Starting scan…', 'linkhawk' ); ?></span>
        ...
        <div class="lgp-progress-stats">
            <span><?php esc_html_e( 'Broken found:', 'linkhawk' ); ?> <strong id="lgp-progress-broken">0</strong></span>
            <span><?php esc_html_e( 'Posts scanned:', 'linkhawk' ); ?> <strong id="lgp-progress-scanned">0</strong></span>
        </div>
    </div>
...
<div id="lgp-redirect-modal" class="lgp-modal" style="display:none;" role="dialog" aria-modal="true" aria-labelledby="lgp-modal-title">
    ...
    <div class="lgp-modal-box">
        <button class="lgp-modal-close" id="lgp-modal-cancel" aria-label="<?php esc_attr_e( 'Close', 'linkhawk' ); ?>">&times;</button>
        <h2 id="lgp-modal-title">
            <span class="dashicons dashicons-randomize"></span>
            <?php esc_html_e( 'Add 301 Redirect', 'linkhawk' ); ?>
        </h2>
        <p class="lgp-modal-desc"><?php esc_html_e( 'Visitors hitting this broken URL will be permanently redirected to your target.', 'linkhawk' ); ?></p>
        <div class="lgp-modal-fields">
            <div class="lgp-modal-field">
                <label for="lgp-modal-source"><?php esc_html_e( 'Source (broken URL)', 'linkhawk' ); ?></label>
                <input type="url" id="lgp-modal-source" class="widefat" readonly />
                <input type="hidden" id="lgp-modal-link-id" value="" />
            </div>
            <div class="lgp-modal-field">
                <label for="lgp-modal-target"><?php esc_html_e( 'Redirect To', 'linkhawk' ); ?></label>
                <input type="url" id="lgp-modal-target" class="widefat" placeholder="https://example.com/new-page/" required />
                <p class="description"><?php esc_html_e( 'Full URL including https://', 'linkhawk' ); ?></p>
            </div>
        </div>
        ...
        <div class="lgp-modal-footer">
            <button id="lgp-modal-save" class="button button-primary button-large">
                ...
                <?php esc_html_e( 'Save Redirect', 'linkhawk' ); ?>
            </button>
            <button class="button button-large lgp-modal-cancel-btn"><?php esc_html_e( 'Cancel', 'linkhawk' ); ?></button>
        </div>
    </div>
</div>
